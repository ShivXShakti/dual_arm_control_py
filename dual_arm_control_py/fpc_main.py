...
class PositionCommander(Node):
    def __init__(self):
        ...
        self.T_final_l = np.array([[0, 0, 1, l4+l5], 
                                 [0, -1, 0, 0.3], #0.10555,0.176,0.3,0.32,0.2251
                                 [1, 0, 0, -l3], 
                                 [0, 0, 0, 1]])
