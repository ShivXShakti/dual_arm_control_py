...
class TrajectoryGenerator():
    ...
    def compute_jacobian(self, theta, dh_l):
        ...
        expr4 = (sin_t4 * (sin_t3 * sin_t1 - cos_t2 * cos_t3 * cos_t1)- cos_t4 * cos_t1 * sin_t2)
        expr5 = (cos_t5 * (cos_t3 * sin_t1 + cos_t2 * cos_t1 * sin_t3)- sin_t5 * (
                cos_t4 * (sin_t3 * sin_t1 - cos_t2 * cos_t3 * cos_t1)+ cos_t1 * sin_t2 * sin_t4))
        expr6 = (cos_t6 * (sin_t4 * (sin_t3 * sin_t1 - cos_t2 * cos_t3 * cos_t1)- cos_t4 * cos_t1 * sin_t2)
                + sin_t6 * (cos_t5 * (cos_t4 * (sin_t3 * sin_t1 - cos_t2 * cos_t3 * cos_t1)+ cos_t1 * sin_t2 * sin_t4)
        ...
        expr27 = (sin_t6 * (cos_t5 * (cos_t2 * sin_t4 + cos_t3 * cos_t4 * sin_t2) - sin_t2 * sin_t3 * sin_t5)
        ...
        expr36 = (sin_t5 * (cos_t4 * (cos_t1 * sin_t3 + cos_t2 * cos_t3 * sin_t1)- sin_t2 * sin_t4 * sin_t1)
                - cos_t5 * (cos_t3 * cos_t1 - cos_t2 * sin_t3 * sin_t1))
        expr37 = (-sin_t6 * (cos_t5 * (cos_t4 * (cos_t1 * sin_t3 + cos_t2 * cos_t3 * sin_t1)- sin_t2 * sin_t4 * sin_t1)
                + sin_t5 * (cos_t3 * cos_t1 - cos_t2 * sin_t3 * sin_t1))- cos_t6 * (sin_t4 * (cos_t1 * sin_t3 + cos_t2 * cos_t3 * sin_t1)
        ...
        expr42 = l5 * (sin_t6 * (cos_t5 * (cos_t2 * cos_t1 * sin_t4 + cos_t3 * cos_t4 * cos_t1 * sin_t2)- cos_t1 * sin_t2 * sin_t3 * sin_t5)- 
                       cos_t6 * (cos_t2 * cos_t4 * cos_t1 - cos_t3 * cos_t1 * sin_t2 * sin_t4))-l4 * (cos_t2 * cos_t4 * cos_t1 - cos_t3 * cos_t1 * 
                                                                                                      sin_t2 * sin_t4) - l3 * cos_t2 * cos_t1
        expr43 = l4 * sin_t4 * E - l5 * (sin_t6 * (sin_t5 * (sin_t3 * sin_t1 - cos_t2 * cos_t3 * cos_t1)- cos_t4 * cos_t5 * E)- cos_t6 * sin_t4 * E)
